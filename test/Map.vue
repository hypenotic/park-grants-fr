<template v-if="this.$store.state.locationList != null">
    <div>
        ...
        <div class="map-container" v-bind:class="{ 'list-open': this.$store.state.listViewState }">
            ...
            <input id="pac-input" class="controls" type="text" placeholder="Entrez votre adresse pour trouver des événements près de chez vous." style="font-size: 30px;position: absolute; top: 0; z-index: 15;">
