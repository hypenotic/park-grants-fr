<template>
  <div v-if="data != null">
    <section class="videos">
      <div class="overlay">
        <h1>Soutenir les liens essentiels entre les citoyens et les parcs</h1>
        <a href="#learnmore" class="cta_button"> En savoir plus </a>
      </div>
      <div class="hero" v-if="isMobile()">
        <iframe
          v-if="selectedVideo == 0"
          src="https://player.vimeo.com/video/383530025?background=1&loop=1&autoplay=0"
          frameborder="0"
        ...
        <iframe
          ...
          src="https://player.vimeo.com/video/383530166?background=1&loop=1&autoplay=0"
          frameborder="0"
          allow="autoplay; fullscreen"
          allowfullscreen
        ></iframe>
        <iframe
          ...
          src="https://player.vimeo.com/video/383357365?background=1&loop=1&autoplay=0"
          frameborder="0"
          allow="autoplay; fullscreen"
          allowfullscreen
        ></iframe>
      ...
      <div class="hero" v-else>
        <iframe
          v-if="selectedVideo == 0"
          src="https://player.vimeo.com/video/383530025?background=1&loop=1"
          frameborder="0"
          allow="autoplay; fullscreen"
          allowfullscreen
        ></iframe>
        <iframe
          v-if="selectedVideo == 1"
          src="https://player.vimeo.com/video/383530166?background=1&loop=1"
          frameborder="0"
          allow="autoplay; fullscreen"
          allowfullscreen
        ></iframe>
        <iframe
          v-if="selectedVideo == 2"
          src="https://player.vimeo.com/video/383357365?background=1&loop=1"
          frameborder="0"
          allow="autoplay; fullscreen"
          allowfullscreen
        ></iframe>
...
export default {
  ...
  created() {
    axios
      .get("https://parkpeople.ca/wp-json/wp/v2/pages/21012?_embed")
      .then((response) => {
        ...
        axios
          .all([
            axios.get(
              "https://parkpeople.ca/wp-json/wp/v2/case-study/?_embed&categories=134&per_page=15&lang=fr"
            ),
            axios.get(
              "https://parkpeople.ca/wp-json/wp/v2/research/?_embed&categories=134&per_page=15&lang=fr"
            ),
            axios.get(
              "https://parkpeople.ca/wp-json/wp/v2/resource/?_embed&categories=134&per_page=15&lang=fr"
            ),
          ])
          .then(
