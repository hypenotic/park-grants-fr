<template>
  <nav v-if="scrolled == true" id="scrolling" class="navbar green">
    <div class="navbar-brand">
      <div>
        <a href="https://parkpeople.ca/boursesdeparc2019"
          ><img
            src="https://parkpeople.ca/custom/uploads/2019/04/TD_logo_french_-white_nologos.png"
            class="grants-logo"
        /></a>
      </div>
    </div>
    <div class="lang">
      <a
        ...
        href="https://parkpeople.ca/parkgrants/faq"
        >EN</a
      >
    ...
    >
      <div class="navbar-end">
        <a href="https://parkpeople.ca/?lang=fr" class="navbar-item"
          >Page d'accueil</a
        >
        <span
          class="navbar-item"
          v-on:click="showMobileMenu = !showMobileMenu"
          v-if="this.$route.path == '/recipiendaires-de-bourses'"
  ...
  <nav v-else class="navbar green">
    <div class="navbar-brand">
      <div>
        <a href="https://parkpeople.ca/boursesdeparc"
          ><img
            src="https://parkpeople.ca/custom/uploads/2019/04/TD_logo_french_-white_nologos.png"
            class="grants-logo"
        /></a>
